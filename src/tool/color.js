...
define(
    function(require) {
        ...
        // Color palette is an array containing the default colors for the chart's series. 
         ...
         * 转换为rgba格式的颜色
         * @param {Object} color 颜色
         * @return {Object} rgba颜色，rgba(r,g,b,a)
         */
         ...
         * 转换为rgb数字格式的颜色
         * @param {Object} color 颜色
         * @return {Object} rgb颜色，rgb(0,0,0)格式
         */
         ...
         * 转换为HSBA颜色
         * @param {Object} color 颜色
         * @return {Object} HSBA颜色，hsba(h,s,b,a)
         */
        function toHSBA(color,alpha) {
         ...
         * 转换为HSLA颜色
         * @param {Object} color 颜色
         * @return {Object} HSLA颜色，hsla(h,s,l,a)
         */
         ...
         * @param {Object} color 颜色
         * @param {Object} level 升降程度,取值区间[-1,1]
         * @return {Object} 加深或减淡后颜色值
         */
        ...
        function getData(color) {
            ...
            if( r[2] ){
                // #rrggbb
                d = r[2].replace("#","").split(""); 
                var rgb = [d[0]+d[1],d[2]+d[3],d[4]+d[5]];
                ...
                var a = rgba[3];
                data = map(rgb, function(c) {
                    c = Math.floor( c.indexOf("%") > 0 ? parseInt(c) * 2.55 : c );
                    return adjust( c, [0,255] );;
                });
                
                a && data.push( adjust(parseFloat(a), [0,1]) );
            } else if( r[5] || r[6]) { 
                // hsb hsba hsl hsla 
                var hsxa = (r[5] || r[6]).split(",");
                var h = parseInt(hsxa[0])/360;
                var s = hsxa[1];
                var x = hsxa[2];
                var a = hsxa[3];
