...
(function (root, factory) {
    ...
    // Index of TEST_CASE_LIST, for debugging test cases.
    var ONLY_RUN_SINGLE_TEST_INDEX = 15;
    // var ONLY_RUN_SINGLE_TEST_INDEX = null;
    ...
    function runCases(cases) {
        var caseIdx = 0;
        if (ONLY_RUN_SINGLE_TEST_INDEX != null) {
            caseIdx = ONLY_RUN_SINGLE_TEST_INDEX;
            assert(caseIdx < cases.length);
        }
        ...
        for (; caseIdx < cases.length; caseIdx++) {
            addTest(cases[caseIdx]);
            if (ONLY_RUN_SINGLE_TEST_INDEX != null) {
                break;
            }
        }
    ...
    function createTestSuite(zrenderNS, consoleLog) {
        ...
        var TEST_CASE_LIST = [
            ...
            /**
             * 2 calls of el.animateTo/el.animateFrom.
        ...
        for (var caseIdx = 0; caseIdx < TEST_CASE_LIST.length; caseIdx++) {
            cases.push(
                (function (caseIdx) {
                    return function () {
                        consoleLog('[Test Element Animation API]: ' + caseIdx + ' ...');
                        return TEST_CASE_LIST[caseIdx]();
                    };
                })(caseIdx)
            );
        }
